...
Text::Text(SDL_Color){
	font = TTF_OpenFont("fonts/Hyperspace.ttf", 60);
}

unsigned int Text::PowerTwoFloor(unsigned int val){
...
void Text::RenderText(std::string message, SDL_Color color, float x, float y, int size){
	glLoadIdentity();
